...
export function SignInButton() {
  return (
    ...
    >
      <button
        type="submit"
        className="inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow ring-1 ring-slate-200 transition hover:bg-slate-50"
      >
        <GoogleIcon />
        Entrar con Google
      </button>
